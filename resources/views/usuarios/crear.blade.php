        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    <a href="{{route('usuarios.listar')}}" type="button"  aria-haspopup="true" aria-expanded="false" class="btn btn-primary">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body">
                    <x-alerta-component />
                    {!! Form::open(['url' => '/usuarios/PostCearUsuarios','autocomplete' => 'off']) !!}
                        <div class="form-row">
                            <div class="col-md-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="position-relative form-group">
                                    ...
                                    {!! Form::select('rol_id', $roles , null , ['id'=>'rol_id', 'class' => 'form-control form-select','placeholder' => 'Seleccione una Opción','required']) !!}
                                    @error('rol_id')<x-validate-error :message="$message"/>@enderror
                                </div>
                            </div>
                        </div>
